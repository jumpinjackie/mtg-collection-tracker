...
public class StubCollectionTrackingService : ICollectionTrackingService
{
    ...
    public ValueTask<List<LowestPriceCheckItem>> GetLowestPricesAsync(LowestPriceCheckOptions options, CancellationToken cancel)
    {
        throw new System.NotImplementedException();
    }
    ...
    public ValueTask<bool> HasLocalPriceDataAsync(CancellationToken cancel)
    {
        throw new System.NotImplementedException();
    }

    public ValueTask<DateOnly?> GetLatestPriceDataDateAsync(CancellationToken cancel)
    {
        throw new System.NotImplementedException();
    }
